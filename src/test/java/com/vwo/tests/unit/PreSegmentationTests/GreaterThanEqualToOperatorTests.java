...
public class GreaterThanEqualToOperatorTests {
  @Test
  public void GreaterThanEqualToOperatorPass() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}";
  ...
  @Test
  public void GreaterThanEqualToOperatorEqualValuePass() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 150);
      put("expectation", true);
  ...
  @Test
  public void GreaterThanEqualToOperatorFail() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 100);
  ...
  @Test
  public void GreaterThanEqualToOperatorStringValueFail() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gte(150)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq","abc");
      put("expectation", false);
