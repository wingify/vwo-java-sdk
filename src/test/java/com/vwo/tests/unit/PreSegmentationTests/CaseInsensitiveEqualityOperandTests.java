...
public class CaseInsensitiveEqualityOperandTests {

  @Test
  public void exactMatchTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(something)\"}}]}";
  ...
  public void exactMatchWithSpecialCharactersTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(f25u!v@b#k$6%9^f&o*v(m)w_-=+s,./`(*&^%$#@!)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
  ...
  public void exactMatchWithSpacesTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(nice to see you. will    YOU be   my        Friend?)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
  ...
  public void exactMatchWithUpperCaseTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(HgUvshFRjsbTnvsdiUFFTGHFHGvDRT.YGHGH)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
  ...
  public void trimValueTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(HI)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", "          hi          ");
      put("expectation", true);
    }};
  ...
  public void numericDataTypeTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(123)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 123);
      put("expectation", true);
    }};
  ...
  public void floatDataTypeTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(123.456)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 123.456);
      put("expectation", true);
    }};
  ...
  public void stringifiedFloatTest2() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(123.0)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 123);
      put("expectation", true);
    }};
  ...
  public void stringifiedFloatTest3() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(123.4560000)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 123.456);
      put("expectation", true);
    }};
  ...
  public void charDataTypeTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(E)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 'E');
      put("expectation", true);
    }};
  ...
  public void booleanDataTypeTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(true)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", true);
      put("expectation", true);
    }};
  ...
  public void booleanDataTypeTest2() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(false)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", false);
      put("expectation", true);
    }};
  ...
  @Test
  public void booleanDataTypeTest3() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(True)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", true);
      put("expectation", true);
  ...
  public void partOfTextTest() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"lower(zzsomethingzz)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", "something");
      put("expectation", false);
    }};
