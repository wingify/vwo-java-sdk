...
public class GreaterThanOperatorTests {
  @Test
  public void GreaterThanOperatorPass() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gt(150)\"}}]}";
  ...
  @Test
  public void GreaterThanOperatorFail() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gt(150)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 100);
  ...
  @Test
  public void GreaterThanOperatorEqualValueFail() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gt(150)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq", 150);
      put("expectation", false);
  ...
  @Test
  public void GreaterThanOperatorStringValueFail() {
    String dsl = "{\"or\":[{\"custom_variable\":{\"eq\":\"gt(150)\"}}]}";
    Map<String, Object> customVariables = new HashMap<String, Object>() {{
      put("eq","abc");
      put("expectation", false);
