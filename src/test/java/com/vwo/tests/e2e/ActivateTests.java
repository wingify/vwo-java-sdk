...
public class ActivateTests {
  ...
  public void setting1Tests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_50_WEIGHT_50_50, UserExpectations.DEV_TEST_1);
  }
  ...
  public void setting2Tests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_100_WEIGHT_50_50, UserExpectations.DEV_TEST_2);
  }
  ...
  public void setting3Tests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_100_WEIGHT_20_80, UserExpectations.DEV_TEST_3);
  }
  ...
  public void setting4Tests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_20_WEIGHT_10_90, UserExpectations.DEV_TEST_4);
  }
  ...
  public void setting5Tests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_100_WEIGHT_0_100, UserExpectations.DEV_TEST_5);
  }
  ...
  public void setting6Tests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_100_WEIGHT_33_33_33, UserExpectations.DEV_TEST_6);
  }
  ...
  public void settingWith10VariationsTests() throws IOException {
    ...
    validateActivateMethod(com.vwo.tests.data.Settings.AB_TRAFFIC_75_VARIATIONS_10, UserExpectations.AB_TRAFFIC_75_VARIATIONS_10);
  }


  private static void validateActivateMethod(String settingsFile, ArrayList<UserExpectations.Variation> userVariation) throws IOException {
